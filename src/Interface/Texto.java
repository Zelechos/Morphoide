...
public class Texto {
    ...
    public ArrayList getContenidoProtocolosTema1() {
        ...
        String Pagina3 = "<html>"
                + "<body>"
                + "<h1 align = center><FONT SIZE=9><b>Redes de Computadoras</b></font></h1>"
                + "<h2><FONT SIZE=6><b>3 . Fibra òptica</b></font></h2>"
                + "<p>"
                ...
                + "</p>"
                + "<h2><FONT SIZE=6><b>4 . Conectores</b></font></h2>"
                + "<p>"
                ...
                + "</p>"
                + "<h2><FONT SIZE=6>5 . USB (Universal Serial Bus)</font></h2>"
                + "<p>"
                ...
                + "<h2><FONT SIZE=6>6 . Concentrador</font></h2>"
                + "<p>"
        ...
        String Pagina4 = "<html>"
                + "<body>"
                + "<h1 align = center><FONT SIZE=9><b>Redes de Computadoras</b></font></h1>"
                + "<h2><FONT SIZE=6><b>7 . Router</b></font></h2>"
                + "<p>"
                ...
                + "</p>"
                + "<h2><FONT SIZE=6>8 . Bridges(Puente)</font></h2>"
                + "<p>"
                ...
                + "</p>"
                + "<h2><FONT SIZE=6>9 . El Módem</font></h2>"
                + "<p>"
        ...
        String Pagina5 = "<html>"
                + "<body>"
                + "<h1 align = center><FONT SIZE=9><b>Redes de Computadoras</b></font></h1>"
                + "<h2><FONT SIZE=6><b>10 . Comunicación Inalámbrica</b></font></h2>"
                + "<p>"
                ...
                + "</p>"
                + "<h2><FONT SIZE=6>11 . WIFI(Red Inalámbrica)</font></h2>"
                + "<p>"
                ...
                + "esta denominación."
                + "</p>"
                + "<h2><FONT SIZE=6>12. Infrarrojos</font></h2>"
                + "<p>"
